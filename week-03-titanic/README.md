...
| `notebooks/titanic_quality_check.ipynb` | 데이터 품질 점검 노트북 (입문용) |
| `notebooks/titanic_model.ipynb` | 시각화 + 생존 예측 모델 노트북 |
| `notebooks/titanic_correlation_viz.ipynb` | 상관관계 시각화 노트북 (10종 그래프) |
| `notebooks/titanic_validation.ipynb` | 분석 결론 검증 노트북 (교차검증·신뢰구간·비선형) |
| `notebooks/titanic_final_model.ipynb` | 인사이트 기반 최종 예측 모델 |
| `INSIGHTS.md` | 인사이트 보고서 (발견·한계·권고) |
| `reports/` | 품질 점검 그래프 이미지 |

발표 덱 소스는 저장소의 `docs/week-03-titanic/index.html`.
...
브라우저에서 `notebooks/` 안의 노트북을 열고 `Run → Run All Cells` 를 실행합니다.
...
- Live deck: <https://rchoi-v8.github.io/intro-to-data-literacy/week-03-titanic/>
- 소스: `docs/week-03-titanic/index.html`
